...
export function Footer() {
  ...
  return (
    <footer className="border-t border-white/10 glass-card py-12 px-4">
      <div className="max-w-6xl mx-auto">
        <div className="grid md:grid-cols-4 gap-8 mb-8">
          {/* Brand */}
          <div>
            <div className="flex items-center gap-2 mb-4">
              <div className="w-8 h-8 bg-gradient-to-br from-blue-500 to-cyan-500 rounded-lg flex items-center justify-center neon-glow-blue">
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-gray-400">
              ...
              <li><Link href="/applications" className="hover:text-blue-400 transition-colors">Applications</Link></li>
              <li><Link href="/setup" className="hover:text-blue-400 transition-colors">Setup</Link></li>
            </ul>
          </div>
